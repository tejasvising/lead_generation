...
/*const data = [
  {
    date: "10-02-2025",
    customerId: "482598",
    customerName: "Kim Enterprises",
    ewsRating: "High",
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 6, medium: 2, low: 7 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 1, medium: 4, low: 5 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 2, medium: 3, low: 2 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 2, medium: 4, low: 5 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 3, medium: 4, low: 7 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 4, medium: 2, low: 4 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 6, medium: 1, low: 7 }
  },
  {
    date: "10-02-2025",
    customerId: "482598",
    ...
    ewsScore: 4,
    exposure: "USD 70,000,000.00",
    triggers: { high: 2, medium: 5, low: 2 }
  },
];*/
...
const EWSPopupLow = () => {
     const [page, setPage] = useState(0);
      ...
      const lowData = data.filter(row => row.priority === "Low");
    ...
    .join(' ');
        ...
        useEffect(() => {
          const fetchData = async () => {
              try {
                  const response = await fetch(`${API_URL}/donutReport/${window.parent.userName}/low`); //
                  if (!response.ok) {
